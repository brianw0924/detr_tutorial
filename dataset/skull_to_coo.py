...
def MakeData():
    ...
    for phase in phases:
        ...
        root_path = os.path.join("/home/brianw0924/Desktop/DLCVfinal-project-challenge-1-ta-teann/skull/dataset",f"{phase}_skull")
        json_file = os.path.join("/home/brianw0924/Desktop/DLCVfinal-project-challenge-1-ta-teann/skull/dataset",f"{phase}.json")
        ...
        for key, value in records.items():
            ...
            # key: H?_study_series_slice

            if value["series"] in series:

                filename = os.path.join(root_path, f"{key}.jpg")
                ...
                for coord in value["coords"]:
                    ...
                    xmin, ymin = coord[0] - w//2, coord[1] - h//2
                    xmax, ymax = coord[0] + w//2, coord[1] + h//2
                    area = h * w
                    poly = [[xmin, ymin],
                            [xmax, ymin],
                            [xmax, ymax],
